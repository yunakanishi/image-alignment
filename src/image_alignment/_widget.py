"""
This module contains widgets for image alignment functionality:

- Interactive image alignment widget that allows positioning a small image
  over a large image and padding it to match the large image's dimensions.
- Original example widgets for threshold operations.
...
from magicgui.widgets import CheckBox, Container, create_widget, PushButton, Label
